...
class PCMProcessors implements PCMProcessor {
	 ...
	 * @see PCMProcessor#processStreamInfo(cn.pupperclient.libraries.flac.metadata.StreamInfo)
	 */
	 ...
	 * @see PCMProcessor#processPCM(cn.pupperclient.libraries.flac.util.ByteData)
	 */
